...
**Project topology (2026-07-08):** the "Alkimi" Framer project publishes to alkimi.framer.website (preview). The separate "Alkimi (copy)" project owns the production domain www.alkimiworks.com and serves a coming-soon page. Launch = move the domain to the main project and publish — a deliberate manual cutover.
